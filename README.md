...
|<ul><li>[x] </ul>|`POST`|`/user/rentalstate`|get rentalstate.|auth required||
...
|<ul><li>[x] </ul>|`POST`|`/book/search`|search books|no auth||
|<ul><li>[x] </ul>|`POST`|`/book/detail`|show a book rental info|no auth||
...
|<ul><li>[x] </ul>|`POST`|`/action/rental`|rental a book.|auth required|on detail view|
|<ul><li>[x] </ul>|`POST`|`/action/return`|return a book.|auth required|on renting view, detail view|
